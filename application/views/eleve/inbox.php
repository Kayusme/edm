        ...
        <div class="graphs">
	     <div class="xs">
  	     <h3>Bo&icirc;te de r&eacute;ception</h3>
  	        <div class="col-md-4 email-list1">
               <ul class="collection">
                    <li class="collection-item avatar email-unread">
                      <i class="fa fa-users icon_1"></i>
                      <div class="avatar_left">
                      	<span class="email-title">Ecole</span>
                        <p class="truncate grey-text ultra-small">Activités parascolaires</p>
                      </div>
                    ...
                    <li class="collection-item avatar email-unread">
                      ...
                      <div class="avatar_left">
                      	<span class="email-title">Convocation</span>
                      </div>
                    ...
                    <li class="collection-item avatar email-unread">
                      ...
                      <div class="avatar_left">
                      	<span class="email-title">EPSP</span>
                      </div>
